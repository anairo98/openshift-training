...
if "rank" in form.keys():
  rank = form['rank'].value
  name = form['name'].value
  universe = form['universe'].value
  revenue = form['revenue'].value
  r = requests.post("http://"+api_host+":"+api_port+"/cgi-bin/add.py", data={"rank": rank, "name": name, "universe": universe, "revenue": revenue})
...
print('Add new datasets:')
print('<form action="/cgi-bin/app.py" method="post">')
print('  <label for="rank">Rank:</label>')
print('  <input type="number" id="rank" name="rank">')
print('  <label for="name">Name:</label>')
print('  <input type="text" id="name" name="name">')
print('  <label for="universe">Universe:</label>')
print('  <input type="text" id="universe" name="universe">')
print('  <label for="revenue">Revenue:</label>')
print('  <input type="text" id="revenue" name="revenue"><br><br>')
